...
QT_MOC_LITERAL(1, 16, 16), // "mousemove_signal"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 3), // "str"
QT_MOC_LITERAL(4, 38, 9) // "drop_file"

    },
    "MyQGraphicsView\0mousemove_signal\0\0str\0"
    "drop_file"
};
...
void MyQGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mousemove_signal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->drop_file((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQGraphicsView::mousemove_signal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyQGraphicsView::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQGraphicsView::drop_file)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyQGraphicsView::mousemove_signal(QString _t1)
{
...
// SIGNAL 1
void MyQGraphicsView::drop_file(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
