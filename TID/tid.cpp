	...
	ui(new Ui::TIDClass())
{
	...
	QObject::connect(buttonGroup, &QButtonGroup::idClicked, ui->graphicsView, &MyQGraphicsView::setRegionMode);
...
// 设置初始化窗口提示文字
void TID::setHint(const QString& str)
{
	auto item = ui->graphicsView->scene->addText(str, QFont("Microsoft YaHei", 40, QFont::Bold));
